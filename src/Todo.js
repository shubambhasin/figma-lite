...
const Todo = () => {
  ...
  const checkCompleted = (index) => {
    ...
    if (currentTodo[index].completed === false) {
      ...
      currentTodo[index].textDecoration = "line-through";
      ...
      currentTodo[index].textDecoration = "none";
  ...
  return (
    <div className="todo">
     ...
     <div class="todo-container">
        <input value={todo}  placeholder="Enter todo" className="input" onChange={(e) => setTodo(e.target.value)} />
      </div>
